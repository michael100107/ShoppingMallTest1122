package com.example.shoppingmall1122.bean;

import com.example.shoppingmall1122.R;
...
public class PhonesInfo {
    ...
    // 获取默认的手机信息列表
    public static ArrayList<PhonesInfo> getDefaultList() {
        ArrayList<PhonesInfo> goodsList = new ArrayList<PhonesInfo>();
